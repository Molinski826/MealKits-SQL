...
--VALUES ('Jon Jones', 'jonjones@jj.com', 'Premium', '2024-10-26', '2024-10-27', 'HI');
--UPDATE Customers SET SubscriptionLevel = 'Premium' WHERE USERid = 25;
--SELECT COUNT(*) FROM Customers WHERE Email LIKE '%.edu%';
--DELETE FROM Customers WHERE SubscriptionEndDate > '2024-8-1';
--SELECT FullName, Email FROM Customers WHERE SubscriptionLevel = 'Premium' AND State = 'NY' ORDER BY FullName, Email;
--CREATE TABLE Meals (
...
--VALUES 
--('Spaghetti Bolognese', 850, 12.99, 0, 'Premium'),
--('Vegetarian Pizza', 700, 10.50, 1, 'Standard'),
--('Chicken Caesar Salad', 600, 9.75, 0, 'Basic');
--INSERT INTO Meals (MealName, Calories, Price, IsVegetarian, SubscriptionLevel) 
--VALUES ('Truffle Risotto', 700, 25.00, 0, 'Premium'), 
--('Lobster Mac & Cheese', 900, 28.00, 0, 'Premium'), ('Vegetable Quiche', 500, 11.00, 1, 'Standard'), 
--('Roasted Duck Breast', 700, 22.50, 0, 'Premium'), ('Mushroom Stroganoff', 500, 12.00, 1, 'Standard'), 
--('Filet Mignon', 700, 30.00, 0, 'Premium'), ('Greek Salad', 500, 9.00, 1, 'Standard'), 
--('Wild Mushroom Soup', 500, 14.00, 1, 'Premium'), ('Chicken Parmesan', 700, 13.50, 0, 'Standard'), 
...
--SELECT AVG(Price) AS AveragePrice, MAX(Price) AS MaxPrice, MIN(Price) AS MinPrice FROM Meals;
--SELECT * FROM Meals WHERE Price BETWEEN 10.00 AND 20.00;
--ALTER TABLE Meals ADD star_rating INT NULL;
--DROP TABLE Meals;